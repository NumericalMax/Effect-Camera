...
void main() {
	...
	vec3 normalColor1 = BrightnessContrastSaturation(normalColor.rgb, 3.0*u_Brightness, u_Contrast, u_Saturation);

	vec3 normalColor2 = Vignette(normalColor1, texCoord, u_Vignette);

    gl_FragColor = vec4(normalColor2.r*normalColor2.g*normalColor2.b,normalColor2.r*normalColor2.g*normalColor2.b,normalColor2.r*normalColor2.g*normalColor2.b, 1.0);
