 ...
 */
public class TextureShaderProgramEffect7 extends ShaderProgram{
    ...
    public TextureShaderProgramEffect7(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_effect7);
