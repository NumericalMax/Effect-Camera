...
/**
 *
 * Shader Program for the Effect Negative.
 *
 ...
 *
 */
public class TextureShaderProgramNegative extends ShaderProgram {
    ...
    public TextureShaderProgramNegative(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_negative);
