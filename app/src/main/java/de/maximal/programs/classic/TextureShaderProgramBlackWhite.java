...
public class TextureShaderProgramBlackWhite extends ShaderProgram {
    ...
    public TextureShaderProgramBlackWhite(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_blackwhite);
