...
/**
 *
 * Shader Program for the Effect Sepia.
 *
 ...
 *
 */
public class TextureShaderProgramSepia extends ShaderProgram {
    ...
    public TextureShaderProgramSepia(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_sepia);
