...
public class TextureShaderProgramPainted4 extends ShaderProgram{
    ...
    public TextureShaderProgramPainted4(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_painted4);
