...
public class TextureShaderProgramPainted3 extends ShaderProgram{
    ...
    public TextureShaderProgramPainted3(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_painted3);
