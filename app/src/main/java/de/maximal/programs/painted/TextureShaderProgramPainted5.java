...
public class TextureShaderProgramPainted5 extends ShaderProgram{
    ...
    public TextureShaderProgramPainted5(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_painted5);
