...
public class TextureShaderProgramPainted0 extends ShaderProgram{
    ...
    public TextureShaderProgramPainted0(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_painted0);
