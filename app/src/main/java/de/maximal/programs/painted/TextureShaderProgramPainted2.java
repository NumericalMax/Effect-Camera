...
public class TextureShaderProgramPainted2 extends ShaderProgram{
    ...
    public TextureShaderProgramPainted2(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_painted2);
