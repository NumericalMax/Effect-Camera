...
public class TextureShaderProgramTest6 extends ShaderProgram{
    ...
    public TextureShaderProgramTest6(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_test6);
