...
public class TextureShaderProgramTest5 extends ShaderProgram{
    ...
    public TextureShaderProgramTest5(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_test5);
