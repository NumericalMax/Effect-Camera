...
public class TextureShaderProgramTest4 extends ShaderProgram{
    ...
    public TextureShaderProgramTest4(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_test4);
