package de.maximal.programs.test;
...
public class TextureShaderProgramTest2 extends ShaderProgram{
    ...
    public TextureShaderProgramTest2(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_test2);
    ...
    public void setUniforms(float[] matrix, int[] hTex, float strength, float contrast, float brightness, float saturation, float vignette, int grid) {
        ...
        glBindTexture(GLES20.GL_TEXTURE_2D, hTex[1]);
