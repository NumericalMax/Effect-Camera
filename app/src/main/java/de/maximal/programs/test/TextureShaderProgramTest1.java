...
public class TextureShaderProgramTest1 extends ShaderProgram{
    ...
    public TextureShaderProgramTest1(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_test1);
