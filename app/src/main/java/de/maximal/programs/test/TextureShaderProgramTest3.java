...
public class TextureShaderProgramTest3 extends ShaderProgram{
    ...
    public TextureShaderProgramTest3(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_test3);
