...
public class TextureShaderProgramBwLinear extends ShaderProgram{
    ...
    public TextureShaderProgramBwLinear(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_bw_linear);
