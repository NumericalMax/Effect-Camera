...
public class TextureShaderProgramBwLight3 extends ShaderProgram{
    ...
    public TextureShaderProgramBwLight3(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_bw_light3);
