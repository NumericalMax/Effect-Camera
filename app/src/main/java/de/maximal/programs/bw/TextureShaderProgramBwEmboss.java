...
public class TextureShaderProgramBwEmboss extends ShaderProgram{
    ...
    public TextureShaderProgramBwEmboss(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_bw_emboss);
    ...
    public void setUniforms(float[] matrix, int[] hTex, float strength, float contrast, float brightness, float saturation, float vignette) {
        ...
        glBindTexture(GL_TEXTURE_2D, hTex[11]);
