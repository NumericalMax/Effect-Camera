 ...
 */
public class TextureShaderProgramBwLight extends ShaderProgram {
    ...
    public TextureShaderProgramBwLight(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_bw_light);
