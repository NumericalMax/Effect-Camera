...
public class TextureShaderProgramBwDark extends ShaderProgram{
    ...
    public TextureShaderProgramBwDark(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_bw_dark);
