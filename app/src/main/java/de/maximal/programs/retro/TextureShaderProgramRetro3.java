...
public class TextureShaderProgramRetro3 extends ShaderProgram{
    ...
    public TextureShaderProgramRetro3(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_retro3);
