...
public class TextureShaderProgramRetro4 extends ShaderProgram{
    ...
    public TextureShaderProgramRetro4(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_retro4);
