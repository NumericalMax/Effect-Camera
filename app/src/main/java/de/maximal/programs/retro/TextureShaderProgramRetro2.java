...
public class TextureShaderProgramRetro2 extends ShaderProgram{
    ...
    public TextureShaderProgramRetro2(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_retro2);
