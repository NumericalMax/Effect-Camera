...
public class TextureShaderProgramRetro1 extends ShaderProgram{
    ...
    public TextureShaderProgramRetro1(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_retro1);
