package de.maximal.programs.retro;
...
public class TextureShaderProgramRetro0 extends ShaderProgram{
    ...
    public TextureShaderProgramRetro0(Context context){

        super(context, R.raw.texture_vertex_shader, R.raw.texture_fragment_shader_retro0);
    ...
    public void setUniforms(float[] matrix, int[] hTex, float strength, float contrast, float brightness, float saturation, float vignette, int grid) {
        ...
        glBindTexture(GL_TEXTURE_2D, hTex[15]);
